...
namespace personnalisation_chequiers
{
    public partial class Catégorie : Form
    {
        ...
        static SqlCommand cmd = new SqlCommand("select * from Catégorie", cn);
        ...
        {
            // TODO: cette ligne de code charge les données dans la table 'personnalisation_des_ChéquiersDataSet.Catégorie'. Vous pouvez la déplacer ou la supprimer selon vos besoins.
        ...
        private void btnajouter_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.CommandText = "insert into Catégorie (Id,Carte,Libellé_Carte,[Nombre de Formule],Id_Client,papier,format,init)values('" + Convert.ToInt16(textBox1.Text) + "','" + textBox2.Text + "','" + textBox3.Text + "','" + Convert.ToInt16(textBox4.Text) + "','" + Convert.ToInt16(textBox5.Text) + "','" + textBox6.Text + "','" + textBox7.Text + "','" + textBox8.Text + "')";
                cmd.ExecuteNonQuery();
                cn.Close();
        ...
        {
            DialogResult result = MessageBox.Show("Voulez-vous vraiment supprimer cette Catégorie?", "Attention", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (result == DialogResult.Yes)
            {
                try
                {
                    ...
                    cmd.Connection = cn;
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "delete from Catégorie where Id=" + Convert.ToInt16(textBox1.Text);
                    cmd.ExecuteNonQuery();



                    MessageBox.Show("La Catégorie est Supprimer!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);

                    string requete2 = "select * from Catégorie";
        ...
        private void btnmodifier_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    cmd.Connection = D.cn;
                    cmd.CommandText = "update Catégorie set Carte='" + textBox2.Text + "',Libellé_Carte='" + textBox3.Text + "',[Nombre de Formule]='" + Convert.ToInt16(textBox4.Text) + "',Id_Client='" + Convert.ToInt16(textBox5.Text) + "',papier='" + textBox6.Text + "',format='" + textBox7.Text + "',init='" + textBox8.Text + "' where Id ='" + Convert.ToInt16(textBox1.Text) + "'";
                    cmd.ExecuteNonQuery();
                    D.cn.Close();
        ...
        private void btnafficher_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "listCatégoroie";
